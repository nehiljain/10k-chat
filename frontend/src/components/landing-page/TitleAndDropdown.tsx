  ...
  return (
    <div className="landing-page-gradient-1 relative flex h-max w-screen flex-col items-center font-lora ">
      <div className="absolute right-4 top-4">
        <a href="https://www.arallon.ai/" target="_blank">
          <button className="flex items-center justify-center font-nunito text-lg font-bold ">
            By Arallon.AI
            <img src="arallon_ai_logo.png" className="mx-2 rounded-lg" width={40} />
          </button>
        </a>
      </div>
      <div className="mt-28 flex flex-col items-center">
        <div className="w-4/5 text-center text-4xl">
          Analyze SEC 10Ks and 10Qs in Mins, Not Days!
        </div>
        <div className="mt-4 flex items-center justify-center">
          <div className="w-3/5 text-center font-nunito">
            This is a demo product on how you can eliminate the hassle of manually searching through SEC Docs
          </div>
        </div>
      </div>
      {isMobile ? (
        <div className="mt-12 flex h-1/5 w-11/12 rounded border p-4 text-center">
          <div className="text-xl font-bold">
            This is a Demo product that works on a larger screen!
          </div>
        </div>
      ) : (
